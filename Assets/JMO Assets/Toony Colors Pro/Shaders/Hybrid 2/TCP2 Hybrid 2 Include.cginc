...
#if defined(UNITY_INSTANCING_ENABLED) && !(URP_VERSION >= 14 && defined(UNITY_DOTS_INSTANCING_ENABLED))
	#define TCP2_USE_PER_RENDERER_INSTANCING
#endif
...
#if !defined(TCP2_USE_PER_RENDERER_INSTANCING)
	half4 _BaseColor;
	half4 _Color;
#endif
...
#if defined(TCP2_USE_PER_RENDERER_INSTANCING)
UNITY_INSTANCING_BUFFER_START(TCP2PerRenderer)
	UNITY_DEFINE_INSTANCED_PROP(float4, _BaseColor)
	UNITY_DEFINE_INSTANCED_PROP(float4, _Color)
	UNITY_DEFINE_INSTANCED_PROP(float4, _SColor)
	UNITY_DEFINE_INSTANCED_PROP(float4, _HColor)
UNITY_INSTANCING_BUFFER_END(TCP2PerRenderer)

	#undef _BaseColor
	#define _BaseColor UNITY_ACCESS_INSTANCED_PROP(TCP2PerRenderer, _BaseColor)
	#undef _Color
	#define _Color UNITY_ACCESS_INSTANCED_PROP(TCP2PerRenderer, _Color)
	#undef _SColor
	#define _SColor UNITY_ACCESS_INSTANCED_PROP(TCP2PerRenderer, _SColor)
	#undef _HColor
	#define _HColor UNITY_ACCESS_INSTANCED_PROP(TCP2PerRenderer, _HColor)
#endif
